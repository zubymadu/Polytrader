...
BREAKING_NEWS_KEYWORDS = [
    ...
    "rate cut", "powell", "warsh", "yellen", "fed pivot", "emergency rate",
    # Inflation / economy
...
INSTRUMENTS = {
    "XAUUSD": {
        ...
        "bullish_kw": ["war", "conflict", "attack", "inflation", "rate cut",
                       "fed dovish", "warsh dovish", "recession", "crisis", "safe haven",
                       "gold surge", "gold rally", "geopolitical", "sanctions",
                       "nuclear", "default"],
        "bearish_kw": ["rate hike", "fed hawkish", "warsh hawkish", "dollar surge",
                       "gold falls", "gold drops", "risk on", "recovery", "strong dollar"],
        "dxy_effect": -1,
    },
    "US30": {
        ...
        "key_levels": [39000, 40000, 41000, 42000, 43000, 44000, 45000,
                       46000, 47000, 48000],
        "price_fmt":  "${:,.0f}",
        "bullish_kw": ["rate cut", "fed dovish", "warsh dovish", "earnings beat",
                       "jobs growth", "gdp growth", "soft landing", "bull market",
                       "stimulus", "recovery", "risk on"],
        "bearish_kw": ["rate hike", "fed hawkish", "warsh hawkish", "recession",
                       "layoffs", "earnings miss", "inflation surge", "bear market",
